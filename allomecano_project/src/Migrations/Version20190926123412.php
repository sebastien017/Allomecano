 ...
 */
final class Version20190926123412 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD garage_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_C53D045FC4FFF555 ON image');
        $this->addSql('ALTER TABLE image DROP garage_id');
    }
}
